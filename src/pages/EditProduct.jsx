...
import {addProduct,getAllProducts,editProduct} from "../redux/action/RentalAction";
...
<Form.Item name='name' label='product name' rules={[{required: true}]}><Input/></Form.Item>
  ...
  <Form.Item name='rentPerHour' label='Rent Per Hour' rules={[{required: true}]}><Input/></Form.Item>
  <Form.Item name='lens' label='Lens' rules={[{required: true}]}><Input/></Form.Item>
  <Form.Item name='Type' label='Product Type' rules={[{required: true}]}><Input/></Form.Item>
